                ...
                <div id="my-tab-content" class="tab-content">
                    <div class="tab-pane active" id="login">
                        <img class="profile-img" src="https://lh5.googleusercontent.com/-b0-k99FZlyE/AAAAAAAAAAI/AAAAAAAAAAA/eu7opA4byxI/photo.jpg?sz=120"
                             alt="">
                        <form class="form-signin" action="index.php?site=hostlogin" method="post">
                            {$lang['logintowi']}
                            <input type="text" class="form-control" name="loginHostUser" placeholder="{$lang['username']}" required autofocus>
                            <input type="password" class="form-control" name="loginHostPw" placeholder="{$lang['password']}" required>
                            <input type="submit" class="btn btn-lg btn-default btn-block" name="sendloginhost" value="{$lang['login']}" />
                        </form>
                    </div>
                </div>
            </div>
