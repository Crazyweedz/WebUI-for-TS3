        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header text-center">
                    ...
                    <div class="box-tools">
                        <form method="post" action="index.php?site=cgroupeditperm&amp;cgid={$cgid}&amp;sid={$sid}" class="form-inline">
                            ...
                            <div class="input-group" style="width: 150px;">
                                ...
                                <div class="input-group-btn">
                                    <button class="btn btn-sm btn-default" type="submit" name="search" title="{$lang['search']}"><i class="fa fa-search"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="box-body table-responsive no-padding">
                    <form method="post" action="index.php?site=cgroupeditperm&amp;sid={$sid}&amp;cgid={$cgid}">
                        <table class="table table-striped table-hover">
                                    ...
                                    <div style="display:{$display}" id="Lay1">
                                        <table class="table table-striped table-hover" style="width:100%;border-collapse:collapse;" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td colspan="5">&nbsp;<a href="javascript:Klappen(2)"><img src="gfx/images/{$disp_pic}.png" id="Pic2" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['information']}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                ...
                                <td style="width:100%" colspan="6">
                                    <div style="display:{$display}" id="Lay6">
                                        <table class="table table-striped table-hover" style="width:100%;border-collapse:collapse;" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td colspan="5">&nbsp;<a href="javascript:Klappen(8)"><img src="gfx/images/{$disp_pic}.png" id="Pic8" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['administration']}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td colspan="5">&nbsp;<a href="javascript:Klappen(9)"><img src="gfx/images/{$disp_pic}.png" id="Pic9" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['settings']}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                            ...
                            <tr>
                                <td colspan="6">&nbsp;<a href="javascript:Klappen(10)"><img src="gfx/images/{$disp_pic}.png" id="Pic10" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['channel']}</td>
                            </tr>
                            <tr>
                                <td style="width:100%" colspan="6">
                                    <div style="display:{$display}" id="Lay10">
                                        <table class="table table-striped table-hover" style="width:100%;border-collapse:collapse;" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="5">&nbsp;<a href="javascript:Klappen(11)"><img src="gfx/images/{$disp_pic}.png" id="Pic11" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['information']}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td colspan="5">&nbsp;<a href="javascript:Klappen(12)"><img src="gfx/images/{$disp_pic}.png" id="Pic12" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['create']}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td colspan="5">&nbsp;<a href="javascript:Klappen(13)"><img src="gfx/images/{$disp_pic}.png" id="Pic13" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['modify']}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td colspan="5">&nbsp;<a href="javascript:Klappen(14)"><img src="gfx/images/{$disp_pic}.png" id="Pic14" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['delete']}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td colspan="5">&nbsp;<a href="javascript:Klappen(15)"><img src="gfx/images/{$disp_pic}.png" id="Pic15" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['access']}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                ...
                                <td style="width:100%" colspan="6">
                                    <div style="display:{$display}" id="Lay16">
                                        <table class="table table-striped table-hover" style="width:100%;border-collapse:collapse;" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style='width:51px'>&nbsp;</td>
                                                <td colspan="5">&nbsp;<a href="javascript:Klappen(17)"><img src="gfx/images/{$disp_pic}.png" id="Pic17" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['information']}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td colspan="5">&nbsp;<a href="javascript:Klappen(18)"><img src="gfx/images/{$disp_pic}.png" id="Pic18" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['create']}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td colspan="5">&nbsp;<a href="javascript:Klappen(19)"><img src="gfx/images/{$disp_pic}.png" id="Pic19" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['modify']}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td colspan="5">&nbsp;<a href="javascript:Klappen(20)"><img src="gfx/images/{$disp_pic}.png" id="Pic20" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['delete']}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                ...
                                <td style="width:100%" colspan="6">
                                    <div style="display:{$display}" id="Lay21">
                                        <table class="table table-striped table-hover" style="width:100%;border-collapse:collapse;" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style='width:51px'>&nbsp;</td>
                                                <td colspan="5">&nbsp;<a href="javascript:Klappen(22)"><img src="gfx/images/{$disp_pic}.png" id="Pic22" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['information']}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td colspan="5">&nbsp;<a href="javascript:Klappen(23)"><img src="gfx/images/{$disp_pic}.png" id="Pic23" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['admin']}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td colspan="5">&nbsp;<a href="javascript:Klappen(24)"><img src="gfx/images/{$disp_pic}.png" id="Pic24" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['basics']}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td colspan="5">&nbsp;<a href="javascript:Klappen(25)"><img src="gfx/images/{$disp_pic}.png" id="Pic25" border="0" alt="aus/ein-klappen" /></a>&nbsp;{$lang['modify']}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                            ...
                                            {foreach key=key2 item=value2 from=$value.permissions}
                                                {if $showmyperms == 0 AND empty($searchperms) OR $showmyperms == 1 AND $value2['available'] == 1 OR $showmyperms == 0 AND $value2['permname']|strpos:{$searchperms} !== false OR $showmyperms == 0 AND $value2['permid']|strpos:{$searchperms} !== false}
                                                    <tr>
                                                        ...
                                                        <td style="width:45px">{$value2['permid']}</td>
                                                        <td style="width:410px">{$value2['permname']} <br />({$value2['permdesc']})</td>
                                                        <td style="width:50px">
