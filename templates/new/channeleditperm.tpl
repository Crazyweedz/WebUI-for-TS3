        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header text-center">
                    ...
                    <div class="box-tools">
                        <form method="post" action="index.php?site=channeleditperm&amp;cid={$cid}&amp;sid={$sid}" class="form-inline">
                            <label class="checkbox-inline">
                                <input type="checkbox" id="checkboxes-1" name="showmyperms" value="1" onchange="submit()" {if $showmyperms == 1}checked="checked"{/if} />{$lang['showgrantedonly']}
                            </label>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
